...
const u8 gText_ThisIsAPokemon[] = _("You've worked hard, buddy.{PAUSE 96}\p");
...
const u8 gText_WelcomeToHOF[] = _("Thanks for playing!");
...
const u8 gText_LeagueChamp[] = _("YOU MADE IT!\nCONGRATULATIONS!");
...
const u8 gText_ReturnToHealingSpot[] = _("Want to return to the ship?");
