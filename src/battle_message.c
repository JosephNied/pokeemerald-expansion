...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}The {B_OPPONENT_MON1_NAME} was scanned! Got away safely!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT2_WILD]                 = COMPOUND_STRING("...\p"),
    [STRINGID_PLAYERWHITEOUT2_TRAINER]              = COMPOUND_STRING("...\p"),
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("Magnezone carried the team back to the ship..."),
    ...
    [STRINGID_NORUNNINGFROMTRAINERS]                = COMPOUND_STRING("Scanner failed! There is no escape!\p"),
    [STRINGID_CANTESCAPE]                           = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} evaded the scan!\p"),
    ...
    [STRINGID_TRAINERBLOCKEDBALL]                   = COMPOUND_STRING("The Pokemon blocked your Meteor Ball!"),
    [STRINGID_DONTBEATHIEF]                         = COMPOUND_STRING("Couldn't be caught!"),
    ...
    [STRINGID_CANTESCAPE2]                          = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} evaded the scan!\p"),
    ...
    [STRINGID_INSPECT]                              = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} was analyzed and recorded!"),
};
