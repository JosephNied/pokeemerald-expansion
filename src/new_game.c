...
static void SetDefaultOptions(void)
{
    ...
    gSaveBlock2Ptr->optionsWindowFrameType = 11;
...
static void WarpToTruck(void)
{
    if (IS_FRLG)
        ...
        SetWarpDestination(MAP_GROUP(MAP_SPACESHIP_DEV), MAP_NUM(MAP_SPACESHIP_DEV), WARP_ID_NONE, 18, 10);
    WarpIntoMap();
}
