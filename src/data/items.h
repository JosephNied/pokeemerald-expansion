...
// Berries
    ...
    [ITEM_LUM_BERRY] =
    {
        .name = ITEM_NAME("Meteor Berry"),
        .pluralName = ITEM_PLURAL_NAME("Meteor Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
    ...
    [ITEM_SITRUS_BERRY] =
    {
        .name = ITEM_NAME("Star Berry"),
        .pluralName = ITEM_PLURAL_NAME("Star Berries"),
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
