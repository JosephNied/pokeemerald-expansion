...
static const struct MenuAction sMultichoiceList_Planet_Select[] = {
    {COMPOUND_STRING("Earth")},
    {COMPOUND_STRING("Mars")},
    {COMPOUND_STRING("Venus")},
    {gText_Exit}
};

static const struct MenuAction sMultichoiceList_Vitamin_Select[] = {
    {COMPOUND_STRING("Meteor Ball")},
    {COMPOUND_STRING("Air Canister")},
    {gText_Exit},
};
...
static const struct MenuAction sMultichoiceList_Color_Puzzle[] = {
    {COMPOUND_STRING("Red")},
