...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .weight = 408,
        .description = COMPOUND_STRING(
            "They sit in trees, watching. When\n"
            "they open their eyes, everything goes\n"
            "dark. I don't know what's up with them,\n"
            "but it feels... Spooky..."),
        .pokemonScale = 278,
        .pokemonOffset = 3,
        .trainerScale = 256,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_GRASSY_SURGE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
