...
static const u32 sTitleScreenRayquazaGfx[] = INCGFX_U32("graphics/title_screen/testtitle_tiles.png", ".4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCGFX_U32("graphics/title_screen/testtitle_tiles.bin", ".smolTM");
